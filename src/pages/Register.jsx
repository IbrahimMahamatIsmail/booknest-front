...
const Inscription = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post("https://booknest-backend-z9vo.onrender.com/utilisateurs/register", { 
        nom,
        email,
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://booknest-front.vercel.app/register" />
      </Helmet>
